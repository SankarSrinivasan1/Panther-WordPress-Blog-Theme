...
function panther_scripts() {
	...
	wp_enqueue_style( 'panther-icons', get_template_directory_uri() . '/fonts/css/fontello.css', array(), true );
	...
	wp_enqueue_script( 'panther-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'panther-scripts', get_template_directory_uri() . '/js/scripts.min.js', array('jquery'), '', true );		

	wp_enqueue_script( 'panther-main', get_template_directory_uri() . '/js/main.min.js', array('jquery'), '', true );
...
function panther_enqueue_bootstrap() {
	wp_enqueue_style( 'panther-bootstrap', get_template_directory_uri() . '/css/bootstrap/bootstrap.min.css', array(), true );
}
